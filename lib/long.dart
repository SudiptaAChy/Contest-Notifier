...
class LongContest extends StatefulWidget {
  List myList;
  LongContest(this.myList);
  @override
  _LongContestState createState() => _LongContestState(myList);
}

class _LongContestState extends State<LongContest> {
  List myList;
  _LongContestState(this.myList);
